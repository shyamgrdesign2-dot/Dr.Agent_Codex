...
export const typographyScale: TypographyEntry[] = [
  ...
  // Caption & Micro (Inter)
  { name: "Caption LG", element: "span", fontFamily: "Inter", size: "13px", weight: "500", lineHeight: "18px", letterSpacing: "0.005em", paragraphSpacing: "8px", textCase: "none", textDecoration: "none", usage: "Helper text, input descriptions" },
  ...
  { name: "Caption SM", element: "span", fontFamily: "Inter", size: "11px", weight: "500", lineHeight: "14px", letterSpacing: "0.01em", paragraphSpacing: "6px", textCase: "none", textDecoration: "none", usage: "Compact badges, dense table captions" },
  ...
  // Special styles
  { name: "Overline", element: "span", fontFamily: "Inter", size: "11px", weight: "700", lineHeight: "14px", letterSpacing: "0.08em", paragraphSpacing: "8px", textCase: "uppercase", textDecoration: "none", usage: "Section overlines, category labels" },
...
export const fontSizeScale = [
  ...
  { size: "11px", token: "xs", usage: "Overlines, caption-sm" },
  { size: "12px", token: "sm", usage: "Captions, badges, timestamps" },
  { size: "13px", token: "caption-lg", usage: "Helper text, input descriptions" },
