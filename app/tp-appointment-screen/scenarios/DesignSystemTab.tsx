...
const CARD_CATALOG: CardSpec[] = [
  // ── Summary Cards ──
  {
    ...
    copyActions: ["Copy all (vitals + labs + conditions + allergies + meds)"],
  ...
  },
  {
    ...
    copyActions: ["Copy all to RxPad", "Per-section copy", "Per-item copy with 'Copied' flash"],
  ...
  },
  {
    ...
    copyActions: ["Copy all sections", "Per-section copy to RxPad"],
  ...
  },
  {
    ...
    copyActions: ["Copy all medications"],
  ...
  // ── Data Cards ──
  {
    ...
    copyActions: ["Copy flagged lab values"],
  ...
  },
  {
    ...
    copyActions: ["Copy all vitals data"],
  ...
  },
  {
    ...
    copyActions: ["Copy comparison data"],
    pillActions: [],
    collapsible: true,
  ...
  // ── Action Cards ──
  {
    ...
    copyActions: ["Copy selected diagnoses", "Copy all to RxPad"],
    pillActions: [],
    collapsible: true,
  ...
  },
  {
    ...
    copyActions: ["Copy all to RxPad via payload"],
    pillActions: [],
    collapsible: true,
  ...
  },
  {
    ...
    copyActions: ["Copy selected to RxPad"],
    pillActions: [],
    collapsible: true,
  ...
  },
  {
    ...
    copyActions: ["Copy recommended option"],
  ...
  },
  {
    ...
    copyActions: ["Copy all to RxPad", "Per-item copy"],
  ...
  },
  {
    ...
    copyActions: ["Copy all structured data", "Per-section copy"],
  ...
  },
  {
    ...
    copyActions: ["Copy follow-up list"],
    pillActions: [],
    collapsible: true,
  ...
  },
  {
    ...
    copyActions: ["Copy condition data"],
    pillActions: [],
    collapsible: true,
...
const INTERACTIONS: InteractionPattern[] = [
  {
    pattern: "Copy All",
    description: "DocumentCopy icon next to title. Tooltip on hover with actionable label.",
  ...
  {
    pattern: "Copy Button (Blue)",
    description: "Outlined blue button for primary copy actions (Copy to RxPad).",
              ...
              <div className="space-y-2 text-[10px]">
                <div className="flex items-center gap-2 rounded bg-blue-50 p-2">
                  ...
                  <div>
                    ...
                    <span className="text-slate-500"> — Icon (24x24) + Title (12px/600) + Copy + Badge + Collapse</span>
                  </div>
                </div>
              ...
              <table className="w-full text-[10px]">
                ...
                <tbody>
                  {[
                    ...
                    ["copyAll", "() => void?", "—", "Adds DocumentCopy icon with ActionableTooltip"],
