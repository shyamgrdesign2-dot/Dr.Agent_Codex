...
const PAST_VISITS: PastVisitEntry[] = [
  {
    ...
    digitalRx: {
      symptoms: [
        { label: "Fever", detail: "2 days | High | No measured temperature" },
        { label: "Redness in both eyes", detail: "2 days | High | Conjunctival congestion" },
      ],
      examinations: [
        { label: "Lung Infection", detail: "Mild crepitations in bilateral lower zones" },
      ],
      diagnoses: [
        { label: "Viral Fever", detail: "2 days | Moderate" },
        { label: "Conjunctivitis", detail: "Acute | Bilateral" },
      ],
      medications: [
        {
          label: "Telma20 Tablet",
          detail: "1 tablet | 1-0-0-1 | Before Food | 4 days",
          row: {
            medicine: "Telma20 Tablet",
            unitPerDose: "1 Tablet",
            frequency: "1 - 0 - 0 - 1",
            when: "Before Food",
            duration: "4 Days",
            note: "Stop if no fever",
          },
        },
        {
          label: "Metsmail 500 Tablet",
          detail: "1 tablet | 1-0-0-1 | After Food | 4 days",
          row: {
            medicine: "Metsmail 500 Tablet",
            unitPerDose: "1 Tablet",
            frequency: "1 - 0 - 0 - 1",
            when: "After Food",
            duration: "4 Days",
            note: "Hydration advised",
          },
        },
      ],
      advice: "Hydration, eye hygiene, and steam inhalation. Return if fever persists for 48 hours.",
      followUp: "After 2 weeks",
      labInvestigations: ["CBC", "LFT"],
      vitals: {
        bpSystolic: "120",
        bpDiastolic: "75",
        temperature: "99.8",
      ...
      additionalNotes: "Digital Rx imported from 27 Jan consultation.",
    },
    writtenRx: [
      {
        id: "wrx-27-a",
  ...
  },
  {
    ...
    digitalRx: {
      symptoms: [
        { label: "Cough", detail: "3 days | Productive | Night worsening" },
        { label: "Mild breathlessness", detail: "Intermittent | Exertional" },
      ],
      examinations: [{ label: "Chest auscultation", detail: "Rhonchi present" }],
      diagnoses: [{ label: "Acute Bronchitis", detail: "3 days | Mild" }],
      medications: [
        {
          label: "Azithromycin 500",
          detail: "1 tablet | 1-0-0 | After Food | 3 days",
          row: {
      ...
      additionalNotes: "Digital Rx imported from 26 Jan consultation.",
    },
    writtenRx: [],
  },
  {
    ...
    digitalRx: {
      symptoms: [
        { label: "Headache", detail: "1 day | Frontal | Intermittent" },
        { label: "Photophobia", detail: "Mild" },
      ],
      examinations: [{ label: "Neurological exam", detail: "No focal deficits" }],
      diagnoses: [{ label: "Migraine (episodic)", detail: "Known history" }],
      medications: [
        {
          label: "Naproxen 250",
          detail: "1 tablet | SOS | After Food",
          row: {
            medicine: "Naproxen 250",
            unitPerDose: "1 Tablet",
            frequency: "SOS",
            when: "After Food",
      ...
      additionalNotes: "Digital Rx imported from 24 Jan consultation.",
    },
    writtenRx: [
      {
        id: "wrx-24-a",
