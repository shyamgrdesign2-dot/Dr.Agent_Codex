...
export function DocumentAttachmentBubble({ attachment }: DocumentAttachmentBubbleProps) {
  return (
    <div className="flex items-center gap-[8px] rounded-[8px] border border-tp-slate-200 bg-white px-[10px] py-[8px] shadow-sm">
      {/* PDF icon */}
      <div className="flex h-[32px] w-[26px] shrink-0 items-center justify-center rounded-[4px] bg-red-50">
        <svg width="16" height="18" viewBox="0 0 16 18" fill="none">
          ...
          />
          <path d="M10 1V5H14" stroke="#EF4444" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
          <text x="8" y="13" textAnchor="middle" fill="#EF4444" fontSize="5" fontWeight="700" fontFamily="sans-serif">
            PDF
          </text>
        </svg>
      </div>
