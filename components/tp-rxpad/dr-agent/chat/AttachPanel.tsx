  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between border-b border-tp-slate-100 px-[12px] py-[6px]">
        <span className="text-[11px] font-semibold text-tp-slate-600">Select a document to upload</span>
        <button
          type="button"
          onClick={onClose}
        ...
        {DUMMY_FILES.map((file) => (
          ...
          >
            ...
            <div className="flex min-w-0 flex-1 flex-col">
              <span className="truncate text-[11px] font-medium text-tp-slate-700">{file.name}</span>
              <span className="text-[9px] text-tp-slate-400">{file.pages} {file.pages === 1 ? "page" : "pages"} &middot; {file.size}</span>
            </div>
